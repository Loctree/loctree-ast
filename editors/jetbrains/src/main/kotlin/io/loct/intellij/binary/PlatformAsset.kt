 ...
 * on Loctree/loctree-release: darwin-arm64, darwin-x64, linux-x64 — the
 * same three platforms the VS Code extension ships for. Advertising an
...
object PlatformAsset {
    ...
    const val SUPPORTED_PLATFORMS: String = "macOS arm64, macOS x64, Linux x64"

    /**
     * Release asset name for the OS/arch pair, or `null` when the
     * platform has no published artifact. Windows and Linux arm64 are
