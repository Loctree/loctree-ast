...
class PlatformAssetTest {
    ...
    fun assetMatrixListsOnlyPublishedBinaries() {
        // Exactly the raw assets published on Loctree/loctree-release.
        ...
        assertEquals("loctree-lsp-windows-x64.exe", PlatformAsset.assetName(OsFamily.WINDOWS, Arch.X64))
    }

    @Test
    fun unsupportedPairsReturnNull() {
        // Windows arm64 and Linux arm64 have NO published loctree-lsp asset;
